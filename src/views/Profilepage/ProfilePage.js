  ...
  return (
    <div>
        ...
        <Box sx={{ display: "flex", flexDirection: "row" }}>
            ...
            <Box sx={{display: "flex", flexDirection: "column",alignItems:"center", width: "33%",height:"100vh"}}>
                <Box
                    component="img"
                    sx={{
                        mt:10,
                ...
                <Box sx={{ display: "flex", flexDirection: "row" }}>
                  ...
                  /> }
                    ...
                    variant="contained"
                    sx={{ml: 2, mt:5,width:10,height:30, backgroundColor:"#656268"}}
                    >
                        update
                    </Button>
            ...
            <Box sx={{display: "flex", flexDirection: "column",alignItems:"center", width: "34%",height:"100vh"}}>
                <Typography variant="h4" sx={{mt:5}}>
                    Your Finished Tasks:
                </Typography>
            </Box>
